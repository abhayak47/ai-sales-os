...
export default function LeadDetail() {
  ...
  const handleAddActivity = async (e) => {
    e.preventDefault();
    try {
      await API.post("/activities/", { ...activityForm, lead_id: parseInt(id) });
    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 overflow-y-auto mt-16 md:mt-0">
        ...
        <div className="p-4 md:p-8">
          ...
          {/* Smart Follow-Up Tab — Full Width */}
          ...
          {/* Timeline + AI Brain — Two Column Layout */}
          {activeTab !== "smart_followup" && (
                      ...
                      <form onSubmit={handleAddActivity} className="border border-white/10 rounded-xl p-5 mb-4 space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <select value={activityForm.type}
                          ...
                          <div>
                            ...
                            <input type="text" value={activityForm.title}
                              ...
                              placeholder="e.g. Called and discussed pricing" required
                        ...
                        <div>
                          ...
                          <textarea value={activityForm.description}
                            ...
                            placeholder="What happened? What was discussed?" rows={2}
                      ...
                      <div className="space-y-3">
                        {activities.map((activity) => (
                          <div key={activity.id} className="flex gap-4 border border-white/10 rounded-xl p-4 hover:border-white/20 transition">
                            <div className="text-2xl flex-shrink-0">{ACTIVITY_ICONS[activity.type] || "📌"}</div>
                            ...
                            <button onClick={() => handleDeleteActivity(activity.id)}
                              className="text-white/20 hover:text-red-400 transition text-sm flex-shrink-0">✕</button>
                          </div>
                        ))}
                      </div>
                    )}
                  ...
                  <div>
                    {!analysis ? (
                      <div className="text-center py-12 border border-white/10 rounded-xl">
                        ...
                        <p className="text-white/40 text-sm mb-6">Get deal score, win probability, risk factors and next best action.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-white/10 rounded-xl p-4">
                  ...
                  <div className={`text-2xl font-bold mb-2 ${
                    ...
                    {lead.health_status === "Hot" ? "🔥" : lead.health_status === "Warm" ? "⚡" : "❄️"} {lead.health_status || "Warm"}
                  </div>
                ...
                {lead.score > 0 && (
                  <div className="border border-white/10 rounded-xl p-4">
                    ...
                    {lead.predicted_revenue > 0 && (
                      <div className="mt-3 text-white/40 text-sm">💰 Est. value: ₹{lead.predicted_revenue.toLocaleString()}</div>
                    )}
                  </div>
                )}
